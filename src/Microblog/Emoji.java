 ...
 */
public class Emoji {
  private static String[] positiveEmoji = {"[嘻嘻]", "[爱你]", "[心]", "[挤眼]", "[抱抱]",
  ...
  private static String[] neutralEmoji = {"[哈哈]", "[偷笑]", "[doge]", "[泪]", "[阴险]", "[话筒]", "[围观]", "[din閃避]",
      "[喵喵]", "[带着微博去旅行]", "[思考]", "[月亮]", "[最右]", "[lt吃东西]", "[来]", "[电影]", "[猪头]", "[淚]",
      "[疑问]", "[浮云]", "[钟]", "[瞧瞧]", "[群体围观]", "[神马]", "[雪]", "[想一想]", "[疑問]", "[熊猫]", "[微风]",
      "[睡觉]", "[飞机]", "[lt最右]", "[照相机]", "[咖啡]", "[蜡烛]"};
  private static String[] negativeEmoji = {"[呵呵]", "[抓狂]", "[挖鼻屎]", "[汗]", "[衰]", "[怒]", "[晕]",
